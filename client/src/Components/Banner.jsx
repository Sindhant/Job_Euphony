    ...
    <div className="max-w-screen-2xl container mx-auto xl:px-24 md:py-20 py-14 ">
      ...
      <form>
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
          <div className="flex md:rounded-s-md rounded shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 md:w-1/2 w-full ">
            <input
              type="text"
              name="title"
              id="title"
